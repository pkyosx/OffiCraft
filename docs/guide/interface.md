...
**請示卡那一頁有一個編號欄位**，網址帶進來的編號會自動填進去，所以你看得出來畫面為什麼只剩一張，也可以直接改或清掉。按「清除篩選」回到完整清單，網址也跟著還原。**編號打錯或那一張不在**，清單會空著並說「沒有符合篩選條件的請示」，不會假裝你已經全部處理完。

**任務那一頁沒有編號欄位，但網址帶編號一樣會篩**（連已結案、平常看不到的舊票都找得到）。**編號打錯或那一張票不在**，畫面同樣會空著並說「沒有符合篩選條件的任務」，篩選不會自己消失；按「清除篩選」回到完整清單，網址也跟著還原。跟請示卡那一頁的差別只剩一個：畫面上沒有一個欄位讓你看到目前被哪個編號篩住，也不能直接在畫面上改編號。
