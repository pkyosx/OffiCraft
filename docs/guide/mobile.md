...
座艙是為手機設計過的。你可以在通勤路上回一張 Ask 卡、看今天誰在忙什麼、把專案往前推——
不需要打開電腦。
...
> [!WARNING]
> 座艙背後就是你的整間工作室。**要對外開之前，先確定它是走 tunnel 或 VPN，而不是把埠直接曝在公網上。**

---

## 第二步：加到主畫面

連得到之後，用 Safari 打開座艙網址，然後：
...
> [!NOTE]
> **老實說一件事：現在那顆圖示不會好看。**
> 我們還沒有替座艙設定 App 圖示與名稱（沒有 web app manifest 也沒有 apple-touch-icon），
