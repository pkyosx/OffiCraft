...
// putTheme / deleteTheme drive the theme write and delete handlers as the
// owner. They are the two paths that prune member_theme_avatar rows, so the
// tests above need them next to the association they exercise.
