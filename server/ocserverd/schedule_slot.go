...
// and the schedule simply never fires, with nothing to observe. That
// two-months case is pinned by TestMostRecentSlot/"monthly skips a month
// without the day"; the rest is bounded headroom, not a claim that any real
// schedule needs twelve.
...
// hand-written copy of the calendar; the no-pair case is pinned by
// TestMostRecentCustomSlot/"impossible month and day has no slot" — a mistake
// here would silence a legal schedule, quietly.
//
