...
--
-- 🔴 WHAT WAS ACTUALLY MISSING. `lore_feedback` (00089) exists and holds
...
-- arbitration path arrives, `lore_governance_event` (00089: kind / target /
...
-- the round trip is exercised in migration_00091_lore_proposal_test.go.
