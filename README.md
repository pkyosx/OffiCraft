...
<p align="center">
  <img src="docs/guide/assets/cockpit-mobile-ask.png" alt="手機上的 Ask 頁" width="280" />
</p>
<p align="center"><sub>需要你決定的事會變成一張卡。手機上點一下就推進了。</sub></p>

**它到底能幫你做什麼、為什麼這樣設計** → [docs/guide/why.md](docs/guide/why.md)
...
> 與「需要你點頭時會停下來開卡」，不是系統權限牆。理由與完整邊界見 [docs/guide/why.md](docs/guide/why.md)。
...
- **agent 的環境變數** → [docs/dev/agent-env.md](docs/dev/agent-env.md)
- **開發** → [docs/dev/](docs/dev/)
