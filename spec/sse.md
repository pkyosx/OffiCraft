...
its task landed in a terminal status: walk the §6.3 close-out (clean the task's scratch,
then `report_task_closeout`). Best-effort at-most-once, no queue, no replay.
