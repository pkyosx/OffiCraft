...
export const en: Dict = {
  ...
  settings: {
    ...
    taskCloseWinddown: "Task-close wind-down",
    taskCloseWinddownSub:
      "How long an outsource worker keeps its session after its task is closed — any of the four closes. It shows as stopping for that whole window and leaves the list only once it is actually taken; reporting itself finished takes it sooner, once the server sees the session is really gone. It still holds one of the outsource concurrency slots for that whole window, so back-to-back closes leave new dispatches waiting in the queue with nothing to report it (10–3600)",
