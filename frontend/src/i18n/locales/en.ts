...
export const en: Dict = {
  ...
  settings: {
    ...
    taskCloseWinddownSub:
      "How long an outsource worker keeps its session after its task is closed — any of the four closes. It shows as stopping for that whole window and leaves the list only once it is actually taken; reporting itself finished takes it sooner, once the server sees the session is really gone (10–3600)",
