...
export const en: Dict = {
  ...
  lore: {
    ...
    scopeManualHintLead: "Anyone who opens the “",
    scopeManualHintTail: "” task manual reads it from now on (staff and outsource alike).",
    scopeAgentHintLead: "Only in ",
    scopeAgentHintTail: "'s own boot document; nobody else can read it.",
    scopeOutsourceWarning: "Once this contractor leaves, nobody can read it unless you switch it to a task or everyone.",
    scopeEveryoneHint: "In every member's boot document (all staff + all outsource).",
