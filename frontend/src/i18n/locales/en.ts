...
export const en: Dict = {
  ...
  workerDetail: {
    ...
    avatarPickLabel: "Avatar",
    avatarPickChange: "Choose image",
    avatarPickTitle: "Choose avatar",
    avatarPickClose: "Close",
    avatarPickEmpty: "This theme has no avatar images for this kind. Add images in Settings, Themes to choose one.",
    avatarPickBroken: "The image did not load",
    avatarPickSaving: "Saving…",
    avatarPickError: "The avatar was not saved. Please try again.",
