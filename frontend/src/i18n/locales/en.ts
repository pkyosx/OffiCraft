...
export const en: Dict = {
  ...
  lore: {
    ...
    qualityFlagged: (n: number) => `${n} carry neither a falsifier nor an instance`,
    qualityWhy: "These cannot help even when retrieved — nothing says how to show them wrong, and nothing says they ever happened.",
    qualityShowOnly: "Show only these",
    qualityShowAll: "Show all",
