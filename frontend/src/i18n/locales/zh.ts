...
export const zh = {
  ...
  workerDetail: {
    ...
    avatarPickLabel: "頭像",
    avatarPickChange: "選擇圖像",
    avatarPickTitle: "選擇頭像",
    avatarPickClose: "關閉",
    avatarPickEmpty: "目前主題沒有可用的頭像圖片。到「設定 → 主題」加入圖片後就可以選。",
    avatarPickBroken: "圖片無法顯示",
    avatarPickSaving: "儲存中…",
    avatarPickError: "頭像未儲存，請稍後重試",
    // ── T-f190：對齊成員詳情的真實資訊欄 ──────────────────────────────────
    machine: "機器",
