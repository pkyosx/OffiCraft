...
export const zh = {
  ...
  // 段字取代原本永遠轉不完的「喚醒中…」。文案要能讓人知道下一步做什麼，不是
  // 只說「失敗了」。
  dispatchAlert: {
    wakeTitle: "喚醒沒有送出去",
    wakeBody:
      "指令沒有送達目標機器，這位成員不會醒過來。喚醒意圖已經記下來，系統會在背景重試。",
    relocateTitle: "改機器還沒生效",
    relocateBody:
      "新機器已經指定好，但搬移指令沒有送達，成員還在原本的機器上。系統會在背景重試。",
    step1: "先到「監控」確認目標機器在線 —— 離線的機器收不到指令。",
    step2: "機器顯示在線卻仍然失敗，就改選另一台在線的機器再試一次。",
  },
  profile: {
    title: "個人檔案",
    rename: "改名",
